...
function createMainWindow () {
  ...
  mainWindow = new BrowserWindow({width: 550 , height: 775, icon: fe.join(__dirname, '/mstream-logo-cut.png') });
...
function createInfoWindow(name){
  ...
  // Create new Window
  infoWindow = new BrowserWindow({width: 600 , height: 400, icon: fe.join(__dirname, '/mstream-logo-cut.png') });

  // and load the index.html of the app.
  infoWindow.loadURL('file://' + __dirname + '/windows/' + name + '.html');
...
function createLearnMoreWindow(){
  ...
  // and load the index.html of the app.
  learnMoreWindow.loadURL('file://' + __dirname + '/windows/managed-ddns-ssl-learn-more.html');
...
function bootServer(program2) {
  ...
  // Create Tray Icon
  appIcon = new Tray(fe.join(__dirname, '/mstream-logo-cut.png'));
