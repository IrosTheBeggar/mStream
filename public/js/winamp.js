...
$(document).ready(function () {
    ...
    methods: {
      submitCode: function (e) {
        ...
        MSTREAMAPI.login($('#login-username').val(), $('#login-password').val(), function (response, error) {
          ...
          // Reset Iframe
          $('#webamp-iframe').attr('src', ROOT_PATH + '/webamp/webamp.html?token=' + response.token);
  ...
  function testIt() {
    ...
    MSTREAMAPI.ping(function (response, error) {
      ...
      //
      $('#webamp-iframe').attr('src', ROOT_PATH + '/webamp/webamp.html?token=' + token);
    ...
    $.each(currentBrowsingList, function () {
      if (this.type == 'directory') {
        ...
        if (this.artist != null || this.title != null) {
          filelist.push('<div data-file_location="' + response.path + this.name + '" class="filez"><img class="music-image" src="' + ROOT_PATH + '/public/img/music-note.svg"> <span class="item-text">' + this.artist + ' - ' + this.title + '</span></div>');
        } else {
          filelist.push('<div data-file_location="' + response.path + this.name + '" class="filez"><img class="music-image" src="' + ROOT_PATH + '/public/img/music-note.svg"> <span class="item-text">' + this.name + '</span></div>');
        }
      }
    });
      ...
      if (lowerCase.indexOf(searchVal.toLowerCase()) !== -1) {
        if (this.type === 'directory') {
          ...
          if (this.album_art_file) {
            filelist.push('<div data-album="' + this.name + '" class="albumz"><img class="album-art-box"  data-original="' + ROOT_PATH + '/album-art/' + this.album_art_file + '?token=' + MSTREAMAPI.currentServer.token + '"><span class="explorer-label-1">' + this.name + '</span></div>');
          } else {
            filelist.push('<div data-album="' + this.name + '" class="albumz"><img class="album-art-box" src="' + ROOT_PATH + '/public/img/default.png"><span class="explorer-label-1">' + this.name + '</span></div>');
          }
          ...
          if (programState[programState.length - 1].state === 'playlist') {
            ...
            if (this.artist != null || this.title != null) {
              filelist.push('<div data-file_location="' + path + this.name + '" class="filez"><img class="music-image" src="' + ROOT_PATH + '/public/img/music-note.svg"> <span class="title">' + this.artist + ' - ' + this.title + '</span></div>');
            } else {
              filelist.push('<div data-file_location="' + path + this.name + '" class="filez"><img class="music-image" src="' + ROOT_PATH + '/public/img/music-note.svg"> <span class="title">' + this.name + '</span></div>');
            }
          }
        }
      }
